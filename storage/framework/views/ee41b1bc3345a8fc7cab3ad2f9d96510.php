					...
					<div class="row">
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<select data-valid="required" class="form-control select2" name="application">
									<option value="">Select</option>
									<?php $__currentLoopData = \App\Models\Application::where('client_id',$fetchedData->id)->groupby('workflow')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aplist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php
...
<?php /**PATH C:\xampp\htdocs\bansalcrm\resources\views/Admin/partners/addpartnermodal.blade.php ENDPATH**/ ?>