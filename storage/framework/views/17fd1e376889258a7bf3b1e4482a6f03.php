				...
				<div class="col-3 col-md-3 col-lg-3">
					<div class="card author-box">
						<div class="card-body">
                            ...
                            <p>
                                <a target="_blank" href="<?php echo e(URL::to('/admin/partners/updatecommissionpercentage/'.$fetchedData->id)); ?>" class="btn btn-primary btn-block" style="border-radius:30px;">Update Commission Percentage</a>
                            </p>
                            
                            <p>
                                <a target="_blank" href="<?php echo e(URL::to('/admin/partners/updatecommissionclaimed/'.$fetchedData->id)); ?>" class="btn btn-primary btn-block" style="border-radius:30px;">Update Commission Claimed</a>
                            </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm\resources\views/Admin/partners/detail.blade.php ENDPATH**/ ?>